...
<div class="col-md-12">
  ...
  <a class="<%=_page.equals("customer")?"active":""%>" href="newmenu.jsp?show=customer"><svg class="bi me-2" width="16" height="16"><use xlink:href="#people-circle"/></svg>&nbsp;&nbsp;Customer</a>
  <a class="<%=_page.equals("product")?"active":""%>" href="newmenu.jsp?show=product"><svg class="bi me-2" width="16" height="16"><use xlink:href="#grid"/></svg>&nbsp;&nbsp;Product</a>
  <a class="<%=_page.equals("estimate")?"active":""%>" href="newmenu.jsp?show=estimate"><svg class="bi me-2" width="16" height="16"><use xlink:href="#table"/></svg>&nbsp;&nbsp;Estimate</a>
  <a class="<%=_page.equals("invoice")?"active":""%>" href="newmenu.jsp?show=invoice"><svg class="bi me-2" width="16" height="16"><use xlink:href="#table"/></svg>&nbsp;&nbsp;Invoice</a>
  <hr style="background-color:white">
  <a class="<%=_page.equals("user")?"active":""%>" href="newmenu.jsp?show=user"><svg class="bi me-2" width="16" height="16"><use xlink:href="#tools"/></svg>&nbsp;&nbsp;User</a>
  <a class="<%=_page.equals("invoicereport")?"active":""%>" href="newmenu.jsp?show=invoicereport"><svg class="bi me-2" width="16" height="16"><use xlink:href="#grid"/></svg>&nbsp;&nbsp;Report</a>
</div>
</div>
</div>
<div class="content">
